...
class KFAC(Optimizer):
    ...
    def step(self, update_stats=True, update_params=True, lam=0.0):
    ...
    def _compute_covs(self, group, state):
        ...
        if self._iteration_counter == 0:
            ...
            state["xxt"].addmm_(
                mat1=x, mat2=x.t(), beta=(1.0 - self.alpha), alpha=self.alpha / n
            )
        ...
        if self._iteration_counter == 0:
            ...
            state["ggt"].addmm_(
                mat1=gy, mat2=gy.t(), beta=(1.0 - self.alpha), alpha=self.alpha / n
            )
